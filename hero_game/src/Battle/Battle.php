...
use HeroGame\Display\DisplayBattleInterface;
...
class Battle implements BattleInterface {
    ...
    public function __construct(ConfigInterface $config, DisplayBattleInterface $display)
    {
        $this->config = $config;
    ...
    {
        $this->display->printInitialStats($this);
    }
    
    private function printRoundStats($currentRound)
    {
        $this->display->printRoundStats($this, $currentRound);
    }

    private function printBattleResults()
    {
        $this->display->printBattleResults($this);
    }
}